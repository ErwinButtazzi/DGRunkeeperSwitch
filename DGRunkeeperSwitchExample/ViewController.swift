...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        runkeeperSwitch.addTarget(self, action: #selector(ViewController.switchValueDidChange(_:)), for: .valueChanged)
    ...
    @IBAction func switchValueDidChange(_ sender: DGRunkeeperSwitch!) {
